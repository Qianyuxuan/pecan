...
##' A function to extract soil texture data for a single or group of 
...
# Function to download and extract one type of soil texture data
...
# Function to download and extract three types of soil texture data
